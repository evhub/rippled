...
public:
    ...
    {
        log <<
            "name                                    |     collision |  distribution | time (milliseconds)" << std::endl <<
            "----------------------------------------+---------------+---------------+--------------------";
        ...
        test_hasher <hash_append_tests::jenkins1, FastKey>      ("jenkins1 <FastKey>",  10000000);
        test_hasher <hash_append_tests::spooky, FastKey>        ("spooky <FastKey>",    10000000);
        test_hasher <hash_append_tests::fnv1a, FastKey>         ("fnv1a <FastKey>",     10000000);
    }
};
